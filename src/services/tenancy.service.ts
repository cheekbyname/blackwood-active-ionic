...
export class TenancyService {
    ...
    constructor(private api: WebApi, private comSrv: CommService, private memSrv: MemberService, private propSrv: PropertyService) {
    ...
    setCurrentTenancy(ten: Tenancy): TenancyView {
		...
		this.view.comms = this.comSrv.allComms.filter(com => { return com.houseRef === this.view.tenancy.houseRef
